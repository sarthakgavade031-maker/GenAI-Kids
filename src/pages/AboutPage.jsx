...
const ui = {
    mr: {
        ...
        teamTitle: '👨‍💻 Builder',
        teamDesc: 'GenAI Kids हे GTES (Global Tech Ecosystem) चा एक भाग आहे — एक 18 वर्षीय entrepreneur ने बनवलेलं platform जो भारतातील मुलांचं AI भविष्य बदलण्याच्या mission वर आहे.',
    ...
    hi: {
        ...
        teamTitle: '👨‍💻 Builder',
        teamDesc: 'GenAI Kids GTES (Global Tech Ecosystem) का एक हिस्सा है — एक 18 साल के entrepreneur ने बनाया जो भारत के बच्चों का AI भविष्य बदलने के mission पर है।',
        visionTitle: '🚀 Vision 2030',
    ...
    en: {
        ...
        teamTitle: '👨‍💻 Builder',
        teamDesc: 'GenAI Kids is part of GTES (Global Tech Ecosystem) — built by an 18-year-old entrepreneur on a mission to transform the AI future of Indian children.',
        visionTitle: '🚀 Vision 2030',
            ...
            <div className="about-container">
                ...
                <div className="about-hero">
                    ...
                    <p className="about-tagline">
                        {selectedLang === 'mr' ? 'AI शिका, खेळत खेळत! 🚀' : selectedLang === 'hi' ? 'AI सीखो, खेलते खेलते! 🚀' : 'Learn AI, The Fun Way! 🚀'}
                    </p>
                </div>
                    ...
                    <div className="impact-grid">
                        {impactData.map((item, i) => (
                            <div key={i} className="impact-card" style={{ borderColor: item.color }}>
                                ...
                                <div className="impact-label">{item.label[selectedLang]}</div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="about-card team-card">
                    ...
                    <div className="team-profile">
                        ...
                        <div>
                            <h3 style={{ color: '#a78bfa', marginBottom: '8px' }}>GTES (Global Tech Ecosystem)</h3>
                ...
                <div className="about-card vision-card">
                    ...
                    <div className="vision-timeline">
                        {[
                            { year: '2026', label: selectedLang === 'mr' ? 'Launch & Beta' : 'Launch & Beta', done: true },
                            { year: '2027', label: selectedLang === 'mr' ? '1 लाख Users' : selectedLang === 'hi' ? '1 लाख Users' : '100K Users', done: false },
                            { year: '2028', label: selectedLang === 'mr' ? '10 भाषा' : selectedLang === 'hi' ? '10 भाषाएं' : '10 Languages', done: false },
                            { year: '2030', label: selectedLang === 'mr' ? '1 कोटी मुलं' : selectedLang === 'hi' ? '1 करोड़ बच्चे' : '10M Children', done: false },
                        ].map((item, i) => (
